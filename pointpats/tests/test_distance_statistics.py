...
class TestDistanceStatistics(unittest.TestCase):
    ...
    def test_distance_statistics_K(self):
        ...
        distance_domain_sequence = [ 0.   ,  1.055,  2.11 ,  3.165,  4.22 ,
                                     5.275,  6.33 ,  7.385, 8.44 ,  9.495,
                                     10.55 , 11.605, 12.66 , 13.715, 14.77 ,
                                     15.825, 16.88 , 17.935, 18.99 , 20.045,
                                     21.1  , 22.155]

        envelope = [0.        ,    3.49667116,   13.98668465,   31.47004047,
                    55.94673861,   87.41677908,  125.88016188,  171.336887,
                    223.78695445,  283.23036422,  349.66711633,  423.09721075,
                    503.52064751,  590.93742659,  685.347548  ,  786.75101173,
                    895.1478178 , 1010.53796618, 1132.9214569 , 1262.29828994,
                    1398.6684653 , 1542.031983  ]
    ...
    def test_distance_statistics_L(self):
        ...
        distance_domain_sequence = [ 0.   ,  1.055,  2.11 ,  3.165,  4.22 ,
                                     ...
                                     15.825, 16.88 , 17.935, 18.99 , 20.045,
                                     21.1  , 22.155]
        l_stats = [0.        ,  -1.055     ,  -2.11      ,  -3.165     ,
                   -4.22      ,  -5.275     ,  -6.33      ,  -7.385     ,
                   -8.44      ,  -3.42556019,  -4.48056019,  -5.53556019,
                   -6.59056019,  -7.64556019,  -8.70056019,  -7.24151591,
                   -8.29651591,  -9.35151591, -10.40651591, -11.46151591,
                   -12.51651591, -10.01612038]
